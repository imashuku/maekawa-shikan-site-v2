    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 sm:p-20 relative overflow-hidden">
      ...
      <section className="relative z-10 w-full max-w-5xl flex flex-col md:flex-row items-center justify-center gap-16 py-24 md:py-32">
        ...
        <div className="flex flex-row-reverse gap-6 md:gap-12 min-h-[60vh] md:h-[75vh] items-center justify-center py-8 md:py-0">
          ...
          <div className="flex flex-col gap-0 h-full justify-center pt-8">
            ...
            <p className="text-base md:text-xl font-serif text-sumi/80 vertical-rl tracking-widest leading-loose mt-8 animate-fade-in-up delay-300 select-none">
              近江に眠る、
              <br />
              <span className="border-r-2 border-kokihi pr-2">もう一つの日本史</span>
              <br />
              を紐解く。
            </p>
          </div>
        ...
        <div className="absolute bottom-8 left-0 w-full text-center md:text-left md:pl-12 animate-fade-in">
            ...
            <p className="text-kokihi text-xs md:text-sm font-bold tracking-[0.4em]">前川史観</p>
        </div>
      </section>

      {/* Navigation / Links Placeholder */}
      <div className="z-10 mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg font-serif px-6 md:px-0">
        <Link href="#profile" className="flex items-center justify-center border border-sumi text-sumi px-6 py-4 md:py-3 hover:bg-sumi hover:text-kinari transition-colors duration-300 text-sm md:text-base">
          前川真司について
        </Link>
        <Link href="/support" className="flex items-center justify-center bg-kokihi text-white px-6 py-4 md:py-3 hover:opacity-90 transition-opacity duration-300 shadow-lg text-sm md:text-base">
          書籍化プロジェクトに参加する
        </Link>
      </div>
      ...
      <section id="concept" className="w-full max-w-4xl py-20 md:py-32 px-6 md:px-0">
        <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
                ...
                <div className="space-y-6 text-sumi leading-loose font-serif text-justify text-sm md:text-base">
                    <p>
                        歴史とは、勝者の記録ではありません。<br/>
                        それは、そこに生きた人々の「熱量」の集積です。
                    </p>
                    <p>
                        滋賀・近江の地には、教科書が語り落とした<br/>
                        日本の転換点が数多く眠っています。<br/>
                        織田信長、豊臣秀吉、明智光秀。<br/>
      ...
      <section id="stories" className="w-full bg-sumi-dark text-kinari py-20 md:py-32">
         <div className="max-w-5xl mx-auto px-6 md:px-0">
             <div className="flex justify-between items-end mb-12 md:mb-16 border-b border-kinari/20 pb-4">
                 <div>
                    <h2 className="text-2xl md:text-3xl font-serif font-bold mb-2">歴史の断片</h2>
                    <p className="text-xs opacity-60 tracking-widest">EPISODES</p>
                 </div>
                 <div className="hidden md:block text-right">
                    <p className="font-serif text-sm opacity-80">前川史観で読み解く、<br/>知られざる物語。</p>
                 </div>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                 ...
                 <Link href="/story/kimigahata" className="group block">
                     ...
                     <div className="pr-4">
                         <span className="text-kokihi text-xs font-bold tracking-widest mb-2 block">EPISODE 01</span>
                         <h3 className="text-xl font-serif font-bold mb-3 group-hover:text-kokihi transition-colors leading-relaxed">君ヶ畑：<br/>木地師の源流</h3>
                 ...
                 <Link href="/story/kagaminosato" className="group block">
                     ...
                     <div className="pr-4">
                         <span className="text-kokihi text-xs font-bold tracking-widest mb-2 block">EPISODE 02</span>
                         <h3 className="text-xl font-serif font-bold mb-3 group-hover:text-kokihi transition-colors leading-relaxed">鏡の里：<br/>源平の宿命</h3>
                         <p className="text-xs opacity-60 font-serif leading-relaxed line-clamp-3">
                 ...
                 <Link href="/story/zansho" className="group block">
                     ...
                     <div className="pr-4">
                         <span className="text-kokihi text-xs font-bold tracking-widest mb-2 block">EPISODE 03</span>
                         <h3 className="text-xl font-serif font-bold mb-3 group-hover:text-kokihi transition-colors leading-relaxed">残照の系譜：<br/>渡来の王と技術</h3>
                         <p className="text-xs opacity-60 font-serif leading-relaxed line-clamp-3">
      ...
      <section className="w-full bg-kokihi/5 py-20 md:py-32">
          <div className="max-w-3xl mx-auto px-6 text-center">
              <span className="text-kokihi text-xs font-bold tracking-widest mb-4 block">PROJECT</span>
              <h2 className="text-2xl md:text-4xl font-serif text-sumi-dark mb-8 leading-relaxed">
                  前川史観、書籍化プロジェクト<br/>始動。
              </h2>
              <p className="leading-loose text-sumi font-serif mb-12 text-sm md:text-base">
                  現在、自身の集大成となる歴史ノンフィクションの執筆を進めています。<br/>
                  足で稼いだ一次情報と、独自の仮説が織りなす「もう一つの日本史」。<br/>
      ...
      {/* --- Section: Profile --- */}
      <section id="profile" className="w-full bg-white/50 py-20 md:py-32 border-y border-sumi/10">
          <div className="max-w-4xl mx-auto px-6 md:px-0 flex flex-col-reverse md:flex-row gap-12 items-center">
             ...
             <div className="md:w-2/3">
                 <h2 className="text-xl tracking-widest text-kokihi mb-2 font-serif">PROFILE</h2>
                 <h3 className="text-3xl md:text-4xl font-serif text-sumi-dark mb-6">前川 真司<span className="text-lg ml-4 opacity-50">Shinji Maekawa</span></h3>
                 <p className="text-sm text-sumi/60 mb-6 font-serif">株式会社みんなの奥永源寺 代表取締役</p>
                 
                 <p className="leading-loose text-sumi mb-6 text-sm md:text-base font-serif">
                    1987年、兵庫県宝塚市生まれ。<br/>
                    中学時代の山村留学（高知県大川村）を原点に、農山村の営みに深く惹かれる。<br/>
                    東京農業大学、米国UCLA留学を経て、滋賀県立八日市南高校の農業教員に着任。<br/>
                    そこで絶滅危惧種「紫草（ムラサキ）」と出会い、地域資源としての可能性を見出す。
                 </p>
                 <p className="leading-loose text-sumi text-sm md:text-base font-serif">
                    2014年、地域おこし協力隊として木地師発祥の地・君ヶ畑に移住。<br/>
                    2017年、「株式会社みんなの奥永源寺」を設立。<br/>
                    歴史の深層に眠る敗者の物語と、自然と共生する日本人の精神性を、<br/>
      ...
      <section className="w-full max-w-4xl py-32 px-6 md:px-0">
         <div className="text-center mb-16">
            <h2 className="text-3xl font-serif text-sumi-dark mb-4">書籍化への道程</h2>
         ...
         <div className="relative border-l-2 border-sumi/20 ml-4 md:ml-0 md:pl-0 space-y-12">
             ...
             <div className="relative pl-8 md:pl-0 md:flex md:justify-center items-center gap-8">
                ...
                <div className="md:w-5/12 md:text-right md:order-1">
                   <h3 className="text-xl font-serif font-bold text-kokihi">企画・構想</h3>
                   <p className="text-sm text-kokihi font-bold">2026.01 - 2026.03</p>
                </div>
                <div className="md:w-5/12 md:order-3">
                   <p className="text-sm text-sumi">「前川史観」の核となるテーマを選定。取材開始。<br/>ファンコミュニティの立ち上げ。</p>
                </div>
             </div>
             ...
             <div className="relative pl-8 md:pl-0 md:flex md:justify-center items-center gap-8 opacity-70">
                ...
                <div className="md:w-5/12 md:text-right md:order-1">
                   <h3 className="text-xl font-serif font-bold text-sumi-dark">執筆・連載</h3>
                   <p className="text-sm text-sumi/60">2026.04 - </p>
                </div>
                <div className="md:w-5/12 md:order-3">
                    <div className="bg-white p-4 shadow-sm border border-sumi/10 inline-block">
                         <p className="text-sm text-sumi">noteにて主要エピソードを先行公開予定。<br/>ファンの皆様との対話から物語を深める。</p>
                    </div>
                </div>
             </div>
             ...
             <div className="relative pl-8 md:pl-0 md:flex md:justify-center items-center gap-8 opacity-50">
                <div className="absolute -left-[5px] md:static w-3 h-3 bg-sumi rounded-full md:order-2"></div>
                <div className="md:w-5/12 md:text-right md:order-1">
                   <h3 className="text-xl font-serif font-bold text-sumi-dark">出版・記念講演</h3>
                   <p className="text-sm text-sumi/60">2027.Spring (Planned)</p>
                </div>
                <div className="md:w-5/12 md:order-3">
                   <p className="text-sm text-sumi">全国書店にて発売予定。東近江市にて記念講演会を開催。</p>
                </div>
             </div>
         </div>
      </section>
      ...
      <footer className="w-full bg-sumi-dark text-kinari pt-24 pb-8">
          <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 border-b border-kinari/20 pb-16">
              ...
              <div>
                 <h3 className="text-sm font-bold tracking-widest mb-6 opacity-80">CONTENT</h3>
                 <ul className="space-y-4 text-sm font-serif opacity-60">
                     <li><Link href="/#stories" className="hover:text-kokihi transition-colors">歴史の断片</Link></li>
                     <li><Link href="/#profile" className="hover:text-kokihi transition-colors">プロフィールについて</Link></li>
                     <li><Link href="/support" className="hover:text-kokihi transition-colors">書籍化プロジェクト</Link></li>
                 </ul>
              </div>
              <div>
                 <h3 className="text-sm font-bold tracking-widest mb-6 opacity-80">CONTACT</h3>
                 <ul className="space-y-4 text-sm font-serif opacity-60">
                     <li><Link href="/contact" className="hover:text-kokihi transition-colors">お問い合わせ</Link></li>
                     <li><a href="https://x.com" target="_blank" className="hover:text-kokihi transition-colors">X (Twitter)</a></li>
                 </ul>
              </div>
          </div>
          <div className="text-center text-xs opacity-40 font-serif">
              &copy; {new Date().getFullYear()} Shinji Maekawa Historical View. All Rights Reserved.
          </div>
      </footer>
    </main>
  );
